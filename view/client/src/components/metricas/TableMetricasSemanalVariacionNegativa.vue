<template>
    <div>
        <q-table
            :data="metricas.state.table_metricas_semanal_var_negativa.data"
            :columns="columns"            
            row-key="name"
            dense
            separator="vertical"
        ...
        >
            <template v-slot:top>
                <div  class="row q-gutter-md">                
                    ...
                    <div>{{metricas.state.table_metricas_semanal_var_negativa.count}}/{{metricas.state.table_metricas_semanal_var_negativa.total}}</div>
                </div>
            </template>
        </q-table>        
    </div>
