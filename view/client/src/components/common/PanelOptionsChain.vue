            ...
            <div class="row q-pa-sm">
                ...
                <div class="col-12 row">
                    ...
                    <div class="col-3 q-pl-xs">
                        ...
                        stack-label label="Fch. Expiracion" 
                        color="blue-10"
                        mask="##/##/####"                                   
                        debounce="1000"         
...
import OpcionesContrato from "@/api/opciones-contrato.js"
...
export default {
    ...
    methods:{        
        ...
        get_options_chain:function(){                            
            ...
            let opciones_contrato_api = new OpcionesContrato()

            let response = opciones_contrato_api.get_cadena_de_opciones({
                contract: this.filter.contract,
                cod_symbol:this.filter.symbol.value,
                fch_expiracion:this.filter.expiration_date,
                imp_ejercicio:this.filter.strike,
                flg_opciones_vencidas: this.flg_opciones_vencidas
            })
