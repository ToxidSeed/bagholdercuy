    ...
    <div>
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <q-btn icon="menu" flat color="blue-10" :label="rango_seleccionado.nombre" no-caps>
                        <q-menu>
                            <q-list dense style="min-width: 150px">
                                <q-item clickable v-close-popup class="text-body2" v-for="item in rangos_periodo"
                                    :key="item.codigo" @click="sel_rango(item)">
                                    <q-item-section>
                                        {{ item.nombre }}
                                    </q-item-section>
                                </q-item>
                    ...
                    <div class="row q-gutter-xs">
                        <q-input label="Fecha Desde" stack-label color="blue-10" dense placeholder="dd/mm/yyyy"
                            mask="##/##/####" v-model="fch_desde" />
                        <q-input label="Fecha Hasta" stack-label color="blue-10" dense placeholder="dd/mm/yyyy"
                            mask="##/##/####" v-model="fch_hasta" />
                    </div>
                </div>
            </div>
        </q-card>
        ...
        <div>
            <q-list bordered class="rounded borders">
                <q-expansion-item default-opened expand-separator switch-toggle-side class="text-subtitle1">
...
export default {
    ...
    methods: {
        calc_fechas_rango: function (rango_item) {
            ...
            if (rango_item.codigo == "ULTIMOS_365_DIAS") {
                const now = new Date();
                const fch_365_dias = date.addDays(now, -365)
                this.fch_hasta = date.format(now, "DD/MM/YYYY")
                this.fch_desde = date.format(fch_365_dias, "DD/MM/YYYY")
            }
        },
