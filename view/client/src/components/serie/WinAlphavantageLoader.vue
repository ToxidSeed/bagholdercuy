        ...
        <q-dialog v-model="open">
            <q-card style="width:450px;">
                <q-toolbar>
                    ...
                    Carga de Series desde Alphavantage
                    </q-toolbar-title>
                </q-toolbar>
                <q-separator/>                
                <q-card-section>
...
export default {
    ...
    data() {
        return {
            ...
            fch_hasta: "",
            loading: false,
            lista_modos_carga: ["Append", "Overwrite", "Replace"],
            rangos_fechas: [
                {
    ...
    methods: {        
        ...
        procesar: function() {
            ...
            api_serie.load_alphavantage_series(params).then(resp => {
                this.loading = false
