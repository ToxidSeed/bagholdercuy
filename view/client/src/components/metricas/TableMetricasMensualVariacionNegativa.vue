<template>
    <div>
        <q-table
            :data="metricas.state.table_metricas_mensual_var_negativa.data"
            :columns="columns"            
            row-key="name"
            dense
            separator="vertical"
        ...
        >
            <template v-slot:top>
                <div  class="row q-gutter-md">                
                    ...
                    <div>{{metricas.state.table_metricas_mensual_var_negativa.count}}/{{metricas.state.table_metricas_mensual_var_negativa.total}}</div>
                </div>
            </template>
        </q-table>        
    </div>
...
export default {
    name:"TableMetricasMensualVariacionNegativa",
    data() {
        return {
            data:[],
            columns:[{
