    ...
    >
        <template v-slot:header>
            <q-tr>
                ...
                <q-th class="text-right" style="width:50px;">Maximo</q-th>
                <q-th class="text-right" style="width:50px;">% Maximo</q-th>
        ...
        <template v-slot:body="props">            
            <q-tr :props="props">
                ...
                <q-td key="pct_variacion_maximo" v-bind:class="{'text-red':props.row.pct_variacion_maximo < 0,'text-green':props.row.pct_variacion_maximo >= 0,'text-right':true}">                    
                    {{props.row.pct_variacion_maximo}}
                </q-td>
                <q-td key="imp_variacion_maximo"  v-bind:class="{'bg-orange':props.row.imp_variacion_maximo < 1,'bg-green':props.row.imp_variacion_maximo >= 1,'text-right':true,'text-white':true}">
