    ...
    >
        <template v-slot:header>
            <q-tr>
                ...
                <q-th class="text-right" style="width:50px;">Cierre</q-th>
                <q-th class="text-right" style="width:50px;">% Cierre</q-th>
        ...
        <template v-slot:body="props">            
            <q-tr :props="props">
                ...
                <q-td key="pct_variacion_cierre" v-bind:class="{'text-red':props.row.pct_variacion_cierre < 0,'text-green':props.row.pct_variacion_cierre >= 0,'text-right':true}">                    
