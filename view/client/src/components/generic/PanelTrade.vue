            ...
            <q-card-section>
                ...
                <div class="row">
                    <div class="col-3 q-pl-xs">
                        <q-input class="col-3"
                        v-model="order.fch_transaccion"                  
                        stack-label label="Fch. Transacción" 
                        mask="##/##/####" 
                        fill-mask=""                              
                        >
                ...
                <div class="row">
                    <div class="col-5">
                        <q-input stack-label  v-model="order.cantidad" label="Cantidad" type="number" input-class="text-right"/>
                    </div>                
                    <div class="col-5 q-pl-xs">
                        <q-input stack-label  v-model="order.importe" label="Precio" type="number" input-class="text-right"/>
                    </div>
...
export default {
    ...
    methods:{                
        ...
        option_selected:function(option, order_type){                        
            ...
            this.order.id_instrumento_financiero = this.instrumentosFinancieros.OPTION.id
